...
export const DASHBOARD_REFRESH_INTERVAL_STORAGE_KEY = 'gptimage2api_dashboard_refresh_interval_secs'
export const DASHBOARD_DEFAULT_TIME_RANGE_STORAGE_KEY = 'gptimage2api_dashboard_default_time_range'
