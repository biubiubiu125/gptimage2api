      ...
      >
        <div class="flex h-16 items-center px-5 pt-4 lg:h-20 lg:pt-5">
          <div class="flex min-w-0 items-center">
            <a
              href="https://github.com/biubiubiu125/gptimage2api"
              target="_blank"
            ...
            <div class="sidebar-label sidebar-brand-label">
              <p class="ui-section-title">GPTImage2API</p>
            </div>
          </div>
        </div>
...
const cachedRouteNames = ['Dashboard', 'Studio', 'Accounts', 'Register', 'Logs', 'Monitor', 'Gallery', 'Proxy', 'Settings']
...
const defaultReleasePageUrl = 'https://github.com/biubiubiu125/gptimage2api/releases'
...
function openReleasePage() {
  if (!releasePageUrl.value) return
...
function applyUpdateTask(task: UpdateTaskResponse, open: boolean) {
  ...
  updateProgressState.title = task.busy ? '正在更新 GPTImage2API' : 'GPTImage2API 更新'
