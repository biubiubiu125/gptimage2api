...
export interface ParsedProxyReference {
...
export function parseProxyReference(value: unknown): ParsedProxyReference {
...
export const proxyApi = {
  ...
  listGroups: async () => {
    const view = await apiClient.get<never, ProxyView>('/api/proxy/view')
    return { groups: view.groups }
  },
