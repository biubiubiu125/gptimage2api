...
| `GPTIMAGE2API_IMAGE_QUEUE_GENERATION_CONCURRENCY` | `0` | Per-host generation concurrency; `0` means auto (`max(300, cores×300)`; cores prefer the container cgroup CPU quota, otherwise host cores) |
