...
GPTIMAGE2API_IMAGE_QUEUE_OCCUPANCY_PAUSE_PERCENT=$(dotenv_quote "90")
GPTIMAGE2API_IMAGE_QUEUE_OCCUPANCY_RESUME_PERCENT=$(dotenv_quote "80")
GPTIMAGE2API_IMAGE_QUEUE_OCCUPANCY_HOLD_SECONDS=$(dotenv_quote "2.5")
GPTIMAGE2API_IMAGE_QUEUE_ABSOLUTE_GUARD=$(dotenv_quote "0")
...
run_python() {
  ...
  export GPTIMAGE2API_IMAGE_QUEUE_OCCUPANCY_PAUSE_PERCENT="90"
  export GPTIMAGE2API_IMAGE_QUEUE_OCCUPANCY_RESUME_PERCENT="80"
  export GPTIMAGE2API_IMAGE_QUEUE_OCCUPANCY_HOLD_SECONDS="2.5"
  export GPTIMAGE2API_IMAGE_QUEUE_ABSOLUTE_GUARD="0"
